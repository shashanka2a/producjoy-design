...
export function RecentWorkSection() {
  ...
  return (
    <section id="work" ref={ref} className="px-6 py-32 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-br from-[#8A6BFF]/10 to-[#FF2EF5]/10 rounded-full blur-3xl pointer-events-none" />
